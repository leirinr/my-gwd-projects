((viewport) => {
  ...
  gwd.readyForPlugins = function(container){
    ...
    app.use("duo", {
      ...
      adhesionCta: (exit) => exit("https://theordinary.com/en-us", 'adhesion_hotspot', 'user_tap_adhesion_exitUrl_14257'), // CHANGE URL FOR DUO HERE
      closeCta: (close) => close("auto", "close_button", 'auto_adDismiss_tap_14257'),
    });
  }
